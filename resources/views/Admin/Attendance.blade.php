                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{route('Admin.Attendance.Direct')}}" class="btn btn-sm btn-warning float-right mr-2">Insert</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form id="search-form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 mb-2">
                                            ...
                                            <input type="date" class="form-control" name="search_start_date" id="search_start_date" value="{{date('Y-m-01')}}">
                                        </div>
                                        <div class="col-md-2 mb-2">
                                            <label>End Date</label>
                                            <input type="date" class="form-control" name="search_end_date" id="search_end_date" value="{{date('Y-m-d')}}">
                                        </div>
                                        <div class="col-md-2 mb-2">
                                            <label>Course</label>
                                        ...
                                        <div class="col-md-2 mb-2">
                                            ...
                                            <select class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" name="search_batch" id="search_batch">
                                                ...
                                                @foreach($batches as $batch)
                                                    <option value="{{$batch->BatchID}}">{{$batch->BatchPrefix}}</option>
                                                @endforeach
                                            </select>
                                        </div>

                                        <div class="col-md-3 mb-2">
                                            <button type="submit" class="btn btn-primary mt-4" value="Search">Search</button>
                                        </div>
